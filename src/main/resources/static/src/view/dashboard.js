...
if(page.includes("dashboard")){
    ...
    function printWelcome(){
        if(!sessionStorage.getItem("welcome")){ // Verifica si es la primera vez que se accede al panel.
            document.getElementById("titleMain").innerHTML = `¡Bienvenido de nuevo, <span>${user.getName().split(" ")[0]}!</span>` // Muestra el nombre del usuario en el saludo.
